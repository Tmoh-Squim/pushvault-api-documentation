  ...
  const endpoints = [
    ...
    },
    {
      ...
      notes: [
        ...
        'Opening SPANK without any token starts a local guest demo using the 95% base RTP profile (Easy 96.5%, Medium 95.5%, Hard 94.5%, Hardcore 93.5%); it is not associated with a partner or wallet',
